...
-(void)parseSwing:(NSData*)buffer
{
    ...
    NSLog(@" command = %c full = %@",cmd,tempresult);
    ...
    if(result[0]== '>'){
        switch (cmd) {
            ...
            case '4':
                ...
                break;
            case '5':
                NSLog(@" case 5 unparsed msg!!!!!!! ");
                break;
            case '6':
                NSLog(@" case 6 unparsed msg!!!!!!! ");
                break;
            case '8':
            ...
            case 'c':    // 'c', get continuous mode
                ...
                break;
            case 'd': // Version of Hardware, Firmware
                if ([((NSObject*)_delegate) respondsToSelector:@selector(Swing_Response_version:)])
                {
                    [_delegate Swing_Response_version:tempresult];
                }
                break;
            case 'h': // Charging Status
                if ([((NSObject*)_delegate) respondsToSelector:@selector(Swing_Response_charging:)])
                {
                    [_delegate Swing_Response_charging:tempresult];
                }
                break;
            case 'i':
                NSLog(@" case i unparsed msg!!!!!!! ");
                break;
            ...
            case 'n':
                ...
                break;
            case 'o':
                if ([((NSObject*)_delegate) respondsToSelector:@selector(Swing_Response_lcdMode:)])
                {
                    [_delegate Swing_Response_lcdMode:tempresult];
                }
                break;
            ...
            case 'v': //battery level
                ...
                break;
            case 'y':
                NSLog(@" case y unparsed msg!!!!!!! ");
                break;
            case 'z':
                if ([((NSObject*)_delegate) respondsToSelector:@selector(Swing_Response_name:)])
                {
                    [_delegate Swing_Response_name:tempresult];
                }
                break;
            default:
                //                if ([((NSObject*)_delegate) respondsToSelector:@selector(Swing_Response_TagList:)])
...
-(void)swing_readMemory:(int)bank offset:(int)offset wordLenght:(int)wordLenght;
{
...
-(void)swing_writeMemory:(int)bank offset:(int)offset count:(int)count data:(NSString *)data;
{
...
-(void)swing_selectMemory:(int)bank offset:(int)offset count:(int)count data:(NSString *)data;
{
...
-(void)swing_lockMemory:(int)access kill:(int)kill epc:(int)epc tid:(int)tid user:(int)user accesspassword:(NSString *)accesspassword;
{
...
-(void)swing_set_add_search_target:(NSInteger)idx id_target:(NSString *)id_target;
{
