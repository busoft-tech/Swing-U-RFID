...
-(void)Swing_Response_name:(NSString *)value;
-(void)Swing_Response_version:(NSString *)value;
-(void)Swing_Response_continuous:(NSString *)value;
-(void)Swing_Response_battery:(NSString *)value;
-(void)Swing_Response_charging:(NSString *)value;
-(void)Swing_Response_lcdMode:(NSString *)value;
@end
